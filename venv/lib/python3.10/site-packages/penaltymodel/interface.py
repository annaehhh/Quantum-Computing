    ...
    if use_cache:
        with PenaltyModelCache() as cache:
            try:
                ...
                pass  # generate
    print("Parameters entered into generate function:")
    print("graph_like:", graph_like)
    #print("samples_like:", samples_like)
    #print("linear_bound:", linear_bound)
    #print("quadratic_bound:", quadratic_bound)
    #print("min_classical_gap:", min_classical_gap)
