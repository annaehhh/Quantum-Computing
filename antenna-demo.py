...
def get_existing_towers(filename):
    ...
    print("Anzahl vorhandene Antennen:", len(towers) )
    return towers
...
def build_cqm(num_to_build, existing_towers, new_locs, radius):
    ...
    print("STR:" ,str(tower_vars))
    print("Type:" , type(tower_vars))
    ...
    max_dist = max(dist)
    print("maximale (quadrierte) Distanz:", str(max_dist))
    print("maximale Distanz:", str(max_dist**(1/2)))
...
if __name__ == "__main__":
    ...
    print("Type Sampleset:", type(sampleset))
    print("Type Sampleset-Zeile", sampleset)
